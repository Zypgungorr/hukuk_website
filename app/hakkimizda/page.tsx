...
export default function About() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hikayemiz Section */}
      <section className="relative py-16 min-h-screen md:h-screen bg-gray-800 text-white">
        <div className="absolute inset-0 bg-gray-800/50"></div>
        <div className="relative z-10 container mx-auto h-full flex flex-col justify-center items-center px-4 md:px-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light mb-8 md:mb-16 text-center">Hikayemiz</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 max-w-6xl">
      ...
      {/* Hakkımızda Section */}
      <section className="relative py-16 min-h-screen bg-[#9B1B30] text-white">
        <div className="container mx-auto px-4 md:px-6 py-8 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center max-w-6xl mx-auto">
            <div className="space-y-6 md:space-y-8">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light mb-6 md:mb-12">Hakkımızda</h2>
              <div className="space-y-4 md:space-y-6">
                <p className="text-base md:text-lg font-light leading-relaxed">
      ...
      {/* Aksan Ağı Section */}
      <section className="relative py-16 min-h-screen bg-gray-700 text-white">
        <div className="container mx-auto px-4 md:px-6 py-8 md:py-20">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-light mb-8 md:mb-16 text-center">Aksan Ağı</h2>
            <div className="space-y-8 md:space-y-12">
              <p className="text-base md:text-lg font-light leading-relaxed text-center max-w-4xl mx-auto">
